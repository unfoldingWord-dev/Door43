...
/* adapted from https://github.com/FineUploader/server-examples */
...
class FineUploadHandler {
	...
	public $chunksFolder = '/tmp/chunks';
	...
	public function handleUpload($uploadDirectory, $name = null) {
		...
		if ($totalParts > 1) {
			...
			if (empty($batch))
				...
				$target = join(DIRECTORY_SEPARATOR, array($uploadDirectory, $batch, $name));
